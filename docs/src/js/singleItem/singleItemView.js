...
export function render(object, isFaved){
                            ...
                            <div class="object__desc">
                                ...
                                <div class="object__desc-name">
                                    ...
                                    <button id="addToFavouriteBtn" 
                                            class="button-favourite ${isFaved ? 'button-favourite--active' : ''}">
    ...
    document.querySelector('#app').insertAdjacentHTML('beforeend', markupModel)
}

// Показываем модальноое окно
export function showModal(){
    document.querySelector('.modal-wrapper').classList.remove('none')
}

// Закрываем модальноое окно
